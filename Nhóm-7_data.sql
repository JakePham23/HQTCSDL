...
(N'Haribo'), 
(N'Heineken');
-- Insert 30 rows into KhuyenMai
INSERT INTO KhuyenMai (MaKM, MaSP, LoaiKM, TenKM, NgayBatDau, NgayKetThuc)
VALUES
-- Member Sale (LoaiKM = 1)
(1, 'SP01', 1, N'Kim cương', '2025-01-01', '2025-01-31'),
(2, 'SP02', 1, N'Bạch kim', '2025-01-01', '2025-01-31'),
(3, 'SP03', 1, N'Vàng', '2025-01-01', '2025-01-31'),
(4, 'SP04', 1, N'Bạc', '2025-01-01', '2025-01-31'),
(5, 'SP05', 1, N'Đồng', '2025-01-01', '2025-01-31'),
(6, 'SP06', 1, N'Thân thiết', '2025-01-01', '2025-01-31'),
(7, 'SP07', 1, N'Kim cương', '2025-01-01', '2025-01-31'),
(8, 'SP08', 1, N'Bạch kim', '2025-01-01', '2025-01-31'),
(9, 'SP09', 1, N'Vàng', '2025-01-01', '2025-01-31'),
(10, 'SP10', 1, N'Bạc', '2025-01-01', '2025-01-31'),

-- Flash Sale (LoaiKM = 2)
(11, 'SP11', 2, 'Day 1', '2025-02-01', '2025-02-02'),
(12, 'SP12', 2, 'Day 2', '2025-02-01', '2025-02-02'),
(13, 'SP13', 2, 'Day 3', '2025-02-01', '2025-02-02'),
(14, 'SP14', 2, 'Day 4', '2025-02-01', '2025-02-02'),
(15, 'SP15', 2, 'Day 5', '2025-02-01', '2025-02-02'),
(16, 'SP16', 2, 'Day 6', '2025-02-01', '2025-02-02'),
(17, 'SP17', 2, 'Day 7', '2025-02-01', '2025-02-02'),
(18, 'SP18', 2, 'Day 8', '2025-02-01', '2025-02-02'),
(19, 'SP19', 2, 'Day 9', '2025-02-01', '2025-02-02'),
(20, 'SP20', 2, 'Day 10', '2025-02-01', '2025-02-02'),

-- Combo Sale (LoaiKM = 3)
(21, 'SP21', 3, 'Package A', '2025-03-01', '2025-03-15'),
(22, 'SP22', 3, 'Package B', '2025-03-01', '2025-03-15'),
(23, 'SP23', 3, 'Package C', '2025-03-01', '2025-03-15'),
(24, 'SP24', 3, 'Package D', '2025-03-01', '2025-03-15'),
(25, 'SP25', 3, 'Package E', '2025-03-01', '2025-03-15'),
(26, 'SP26', 3, 'Package F', '2025-03-01', '2025-03-15'),
(27, 'SP27', 3, 'Package G', '2025-03-01', '2025-03-15'),
(28, 'SP28', 3, 'Package H', '2025-03-01', '2025-03-15'),
(29, 'SP29', 3, 'Package I', '2025-03-01', '2025-03-15'),
(30, 'SP30', 3, 'Package J', '2025-03-01', '2025-03-15');

-- Insert 10 rows into MemberSale
...
-- Insert rows into ComboSale with each MaKM linked to 2 MaSP
INSERT INTO ComboSale (LoaiKM, SoLuong, TiLeGiam, MaKM, MaSP)
VALUES
(3, 2, 20, 21, 'SP23'),
(3, 2, 20, 21, 'SP24'),
(3, 3, 25, 22, 'SP25'),
